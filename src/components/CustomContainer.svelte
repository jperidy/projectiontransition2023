...
<div 
    ...
    style={`background-color: ${backgroundHTML}; background-image: url("${API_URL}${backgroundImage}"); background-repeat: no-repeat; background-size: 100%; background-position-x: center;`}
>
    <div class="row">
